...
type Activity[D data.Data] interface {
...
type activity[D data.Data] struct {
	vertex.Vertex[Activity[D]]
	data       D
...
func New[D data.Data](data D) *activity[D] {
...
var _ vertex.Vertex[Activity[data.Data]] = (*activity[data.Data])(nil) //ensures *activity implements vertex.Vertex[Activity] at compile time
var _ Activity[data.Data] = (*activity[data.Data])(nil)                //ensures *activity implements Activity at compile time
